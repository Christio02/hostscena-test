...
const rawNews = [
  ...
  },
  {
    ...
    time: '17:00',
    content: getMockContent(
      'Vi søker frivillige til årets festival!',
      'Send oss en melding dersom du vil bidra.',
    ),
  },
  {
    ...
    time: '10:00',
    content: getMockContent(
      'Fagseminar med spennende tema og foredragsholdere.',
  ...
  },
  {
    ...
    time: '20:00',
    content: getMockContent(
      'Se tilbake på høydepunktene fra festivalen 2024.',
      'Filmen vises i lokal kino og online.',
    ),
  },
  {
    ...
    time: '12:00',
    content: getMockContent(
      'Få en sniktitt på årets festival.',
      'Teaseren gir deg et glimt av hva som kommer.',
    ),
  },
  {
    ...
    time: '19:00',
    content: getMockContent(
      'Opplev litteraturens kraft i boksegallaen.',
      'Forfattersamtaler og opplesninger kombineres her.',
    ),
  },
  {
    image: '/assets/images/newsMock/news1.png',
    ...
    time: '16:00',
    content: getMockContent(
      'Bli med på feiringen av norsk film.',
      'Flere visninger og samtaler med regissører.',
    ),
  },
  {
    image: '/assets/images/newsMock/news2.png',
    ...
    time: '10:00',
    content: getMockContent(
      'Velkommen til årets pressekonferanse.',
      'Vi presenterer årets program og samarbeidspartnere.',
    ),
  },
]
